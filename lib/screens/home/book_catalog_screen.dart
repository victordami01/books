...
import 'package:bookstore/components/book_card.dart'; // Adjust path
import 'package:bookstore/services/cart_manager.dart'; // Import cart manager
...
class _BookCatalogScreenState extends State<BookCatalogScreen> {
  ...
  Future<void> fetchBooks(
    String category,
    Function(List<dynamic>) updateList,
  ) async {
    final url = Uri.parse(
